return {

    {
        ...
        dependencies = {
            ...
            -- keep these only if you want icon highlights:
            "nvim-lua/plenary.nvim",
            "nvim-tree/nvim-web-devicons",
        },
        opts = {
            -- live render in normal + insert mode
            render_modes = { "n", "i" },
    ...
    -- Nice lists/checkboxes auto-indent
    {
        ...
        config = function()
            ...
            vim.keymap.set("n", "<leader>cx", require("autolist").toggle_checkbox, { desc = "Toggle checkbox" })
        end
    },
}
